...
* Teaching Assistant: [Thiago Marques (thiagm@uw.edu)](mailto:thiagm@uw.edu)
   * [Office Hours (Zoom): Thursday: 4:00 - 5:00 ](https://washington.zoom.us/j/97956829333?pwd=RnlnZVNKYWNHQ2Q3a1hhUzRHKzhRdz09)
...
course_outline %>%
  ...
  mutate(Topic =ifelse(Topic == "No Class", Topic, paste0("[", Topic, "](", Link, ")"))) %>%
