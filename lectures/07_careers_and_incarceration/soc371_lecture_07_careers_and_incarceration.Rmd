...
Easiest, cheapest, most effective is to invest in children; note 
...
"When it comes to the role of drug use in criminal careers, Blumstein and Cohen stated that 'drug users without other economic sources of support resort to other forms of crime to obtain the resources for their drug use.' This led to some observers suggesting that decriminalization could diminish the need for crime to purchase drugs. How would the U.S go about decriminalizing drugs? Do you think this would be beneficial to the country as a whole?" and "In other countries, drug use is treated as an illness or addiction rather than a crime. Can the US follow in their footsteps?"

???

Hinges on it suppressing prices--if you decrim but tax too much, probably won't help; consider Dutch provision experiments

--

"Blumstein and Cohen talk about the policy implications of incapacitation and the possibility of time "wasted" by incarcerating people past the end of their criminal careers. Do you believe there should be a maximum age people can be held in jail until? Or do you believe even 70+ year olds should be held for the entirety of their sentence for the retribution/punishment aspect of the crimes they committed in the past?"

---
# Some Questions 2

"In what ways could we reform our criminal justice system so that it is not dealing 'with people only after they have passed through the "participation filter"' (238), rather, proactively intervening to eradicate the factors that compel one to participate in the first place?", "How could understanding participation in crime make an impact on sentencing and deciding imprisonment vs. rehabilitation?" and "In what ways would we have to restructure our system to encourage prevention? And where would this restructuring take place in society?"

--

"Criminal careers generally terminate between 25-30, as our life span increases, will we see a shift to more older criminals? Or will it stay roughly the same because the prime age is still around 18-25?"

---
# Some Clarifications

What did Blumstein & Cohen mean when they say it is difficult to isolate effects of individual predictors of crime (e.g. family, employment)?

???

Their point is that disadvantage is a nexus of things which are interrelated; they all tend to come together. Intervening in one probably doesn't help. Need broad social welfare programs. We'll see the race and disadvantage nexus from multiple angles later in term.

--

How does the inconsistent reporting of crimes--serious violent crimes are more often reported--affect criminal career research? What about racial bias?

???

Work has been done extensively with self-reports like what I noted earlier. Some crime is underexamined, like white collar crime, because it is less often discovered, less often reported, and less often prosecuted. Self-reports address race as well. Some degree of higher participation rates for, in particular, black people is likely due to differential policing, but it doesn't appear to diverge massively from self-reports for robbery and burglary. It diverges a lot for drugs as seen in lecture 4.

--

"Why do most criminals start and end their careers young? Is it due to higher levels of impulsiveness, more physical agility, more reckless behavior at these ages, or something else?" or "do some offenders just move on to crimes that are harder to track? [Like] home invasion and theft to embezzlement?"

???

All these things are relevant--and more! We'll start seeing more on this next lecture with control theory. As far as moving on--self reports indicate generally no. And white collar crimes are generally hard to get into with a criminal history. Stuff usually requires appearing fairly clean. The poor folk version of embezzlement is stealing from the cash drawer.

--

"Since the parameters involved in the 'basic structure of a criminal career' formula do not take into consideration the intention of the crime (e.g. are they a repeat offender due to stealing food to survive?), does this make it an inherently flawed concept?"

???

It depends on the goal. In this case the interest is just in understanding where crime comes from in the aggregate--few crimes from many people or from many crimes by few people. Motivation not important here from the compositional perspective. Worth noting that overwhelming majority of crimes have one of three motives: (1) quick material gain, (2) entertainment, (3) sudden interpersonal conflict.

--

"This article mentioned that reducing enforcement would lower the price of drugs and possibly diminish the need for crime but can't drug dealers inflate the price of drugs at their will?"

???

Demand for some drugs is inelastic--but there are competing suppliers. 
...
* Control Theory
   ...
   + Basic assumption: Some motivation for delinquency is universal
