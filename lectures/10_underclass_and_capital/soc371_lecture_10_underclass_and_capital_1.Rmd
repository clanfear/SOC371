...
date: "Feb 17, 2021<br>Updated: `r gsub(' 0', ' ', format(Sys.Date(), format='%b %d, %Y'))`"
output:
...
Daniel Patrick Moynihan was labor secretary under LBJ--later served under other administrations and was professor at Harvard, Democratic New York Senator from 1977 to 2001.
...
Since poor are disproportionately minority, benefits concentrated there--led to backlash in 1970s as well-off white people perceived they were subsidizing poor black people.
...
* Evidence:
   ...
   * "Moynihan's Scissors": Unemployment dropping, welfare increasing
   * Female-headed families: 25% of births out of wedlock (1965)

???

Moynihan pointed out an apparent paradox. For urban black Americans, unemployment was dropping but welfare enrollment increasing; these two factors normally move together.

Drastic increase in single mothers
...
Essentially the idea is a history of oppression had destroyed black family structures

--

* Conclusion: *Civil rights alone will not produce racial equality*
...
Also argument that black culture had become matriarchal, weakening ability of black men to be authority figures; not inherently problematic, but rather a problem because America is patriarchal. The mismatch is problematic.

The present issue is a self-sustaining tangle of pathology created by centuries of subjugation--even if structural conditions that produced it are removed, it will self-perpetuate. Must intervene to rebuild the family.
...
Post Moynihan report we see rise of competing arguments.

First, culture of poverty: Coming from the right and in some ways drawing on parts of Moynihan to say there exists poverty-sustaining value systems. But they're making argument legal equality has already been achieved.

Critique here is this seems to suggest people could just stop being poor by changing their values. Moynihan wasn't actually saying this--he was making a historical oppression argument. 

But conservative politicians latched on: civil rights made everyone equal, now only racial self-help can solve problem. 
...
.pull-left[
.image-short[![](img/bill_wilson.jpg)]
]
.pull-right[
.image-short[![](img/doug_massey.jpg)]
]

.footnote[\* *... and Quillian too*]
...
He defines the underclass as a heterogeneous group of families and individuals outside mainstream occupation system, including those engaged in street crime and deviance, and those exposed to long term poverty and welfare dependency--and all sharing the same social environment.
...
This work directly engages with cultural behavior under concentrated disadvantage

Lac of opportunity means reliance on welfare and illegal gains for income; no work means no marriageable partners for women
...
Southern African Americans from rural areas migrated en masse from Jim Crow south to northern cities for manufacturing work. This started around 1916, but a second larger wave happened during and after great depression.
...
Main thesis here is changes in the structure of the economy have created inner-city conditions. Key driver to Wilson was massive shift from manufacturing to service economy in full swing during 1970s

Low-skill jobs in inner city greatly reduced, leaving only jobs requiring advanced skills and education. Meanwhile, low skill work dispersed out to white suburbs; no appropriate jobs where black folk live.
...
LAck of Informal networks to provide information on potential jobs, school, and training as well as support in applying for these opportunities. Result is that isolation, dependence, and limited opportunity induce perception of futility--inability to achieve societal goals due to experience with extreme economic marginality; they feel unprepared and world is hostile to their efforts.

In contrast, there are better and more consistent opportunities in the illegal economy
...
Part of factors is departure of black middle class which destabilizes institutions as well as culture, resulting in no role models, no examples of mainstream success, no social connections one can leverage for opportunities.

--

* Solution: Economic interventions
...
Doug Massey is former president of ASA, PAA, possibly most prominent scholar in residential segregation as well as immigration (particularly from Mexico). Wrote American Apartheid with Nancy Denton.

Massey's argument is that the underclass is a symptom of the environment: Black folk are concentrated in worst neighborhood, and this is caused by racial discrimination.

Lot of evidence. Audit studies have continuously discovered biased practices in services that shape residential attainment

Racial preferences, particularly whites for homogeneous communities, drive migration patterns

Description of neighborhoods as dangerous or high crime is usually just code for black residents

Massey says middle class blacks are not departing, because segregation is high regardless of income
...
Lincoln Quillian is a sociologist at Northwestern focusing on racial stratification and segregation.
...
In later work using demographic decompositions, Quillian shows three segregation processes going on. There's direct race segregation and segregation by class. But also, where minorities are not segregated--as is case for Latino pop--they are leaving near only poorest other-race neighbors. That is, where neighborhoods are integrated, it is mainly with poor whites.
...
Wilson & Sampson's work you read is about merging social disorganization with the urban underclass thesis.
