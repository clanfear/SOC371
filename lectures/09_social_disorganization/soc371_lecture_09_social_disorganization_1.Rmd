...
date: "Jul 22, 2020<br>Updated: `r gsub(' 0', ' ', format(Sys.Date(), format='%b %d, %Y'))`"
output:
...
Massive migration into and within US--all into urban centers; different waves from Germany, Ireland, Eastern Europe
...
Faculty and students included Frederick Thrasher (The Gang), Louis Wirth (The Ghetto), Shaw (The Jackroller), Edwin Sutherland, George Herbert Mead, Herbert Blumer

Chicago school as a term usually refers specifically to the urban sociology 
...
Chicago school looked to the logic of natural ecology and evolution, but viewed humans not tied to genetic or trait destiny; rather the structures of their natural built world are what is important.
...
In particular they deep deep interviews with active delinquents to see how they perceived their trajectories in life
...
Burgess's zone in transition had highest delinquency rate--but also wide array of other ills, in particular absence of opportunity

While most folks are conforming and conventional, evidence of competing delinquent and criminal values and groups.
...
Key insight: Chicago's zone in transition had seen many different waves of ethnic groups. Irish, Italian, German, blacks from South. Delinquency rate stayed the same regardless of who was there.
...
They developed a theory that would accomodate the four key empirical findings.
...
No money to invest in upkeep, security, training, and work long hours in hard jobs. Hard to monitor children.
...
Future orientation toward other communities--focus on enduring conditions here to move somewhere better, not fix up where they are.
...
Ample evidence! Quantitatively connect young and old delinquents in primitive network study

In life histories, repeated description of looking up to older offenders, learning techniques and values from them, receiving support
...
Realizing power of gangs in communities, involved them in process; included ex-convicts in prevention programs; reached out to parolees
...
* Both readings indicate social disorganization is a problem causing crime (and other problems) in neighborhoods / communities, and it is caused by lots of things. How do we organize communities then?

--

* "Do you think... community studies [cause] stigmatization toward community groups?"

--

* "Sampson and Groves continually bring up the idea that... street-corner teenage peer groups increase the level of delinquency and crime in a community. As a society we have becoming more and more distant, from social media to the increasing size of the population, so how does this play a role into the prevalence of street-corner groups and their additional crime? "

--

* "Shaw and McKay assume that the wealthier communities have more similar values/morals/attitudes, thus leading to decreased rates of crime. Do you think this is a valid assumption?"

???

Shaw & McKay, to be fair, emphasize the public presentation of these values and attitudes. It is heavily about exposure of youth to these things.

---
# Some Clarifications

* "Given our past knowledge of the strengths and weaknesses of qualitative and quantitative research, where and how is this decision made by critics and other researchers as to where they draw such line of what research style validates longevity of findings or not, or qualifies a work as substantial, or not?" [Also with respect to use of police data]

???

There isn't a hard rule here at all. It is difficult to predict what becomes a classic. Convincing arguments play an important role. Sometimes data that aren't real strong can be used in a novel way to make a large contribution. Lot of great work has used flawed police data for instance. Many high impact studies have been done with qualitative work in limited environments. On quantitative side, burden is usually on authors to show that their findings are insensitive to forseeable issues with their data or models; e.g. even if there was gross differences in reporting, the findings would hold.

--

* "... delinquency is a group phenomenon. Crime doesn't happen unless there's an opportunity. Would places that allow teenagers to meet up count as a place of opportunity? [Wouldn't schools promote delinquency? As places to plan crimes?]"

???

Yes! Locations that facilitate unstructured peer groups--particularly ones that shield them from view--are opportunity spots. Schools provide some monitoring but also get peers linked together into deviant groups. Lot of violence and property crime happens at and near schools. Underfunded schools have fewer monitors as well.

--

* "[Does Shaw & McKay's work suggest] that disadvantaged neighborhoods will always have high crime/delinquency rate? If so, how can we fix it?"

???

Well, yes. Key here is that delinquency is part of a cluster of spatially-concentrated ills. To get rid of crime, you have to address the underlying structural issues that cause all the symptoms.

--

* "How applicable is the social disorganization model to eastern societies?  Are there differences in education systems that contribute to different crime rates?"

???

Some eastern countries do not have the level of poverty or proximal deprivation you see in US. In others, there's substantial concentrated disadvantage in urban areas. Work in social disorg vein has examined, to my knowledge, Japan, Vietnam, and China with general support, but much more limited than US and European work.

---
# More Clarifications

* Does gentrification affect the crime rate? it creates high residential mobility, a lot of racial/ethnic heterogeneity, and mixed socioeconomic status that seems to increase crime rate, but gentrification also brings in money to the neighborhood.

???

Yes! Gentrification has an interesting relationship to crime. Some findings indicate gentrifiers enter neighborhoods and are more likely to report crime, raising crime rates, but over time they decline due to reinvestment and other changes. I have a C&C paper on the policing side of this. Good review out there by MacDonald and Stokes.

--

* "... I am curious to know how micro-level aspects such as family dynamics could impact crime rates in communities?"

???

Systemic model of social control, which is based on social disorganization, includes family level as key element of social control. Family social control is facilitated by community social control. Intergenerational closure for instance.

--

* "What do Sampson & Groves mean [by], 'system of friendship'? Are work/school acquaintances/'friends' and non-familial mentor figures included?" and "Why do [friend networks] develop less frequently in areas with more delinquency, and is this a circular process of crime creates less local friendship networks which creates more crime?"

???

Focus is on non-family friends living in neighborhood--idea is that the more people you know in neighborhood, more ties, more effective interpersonal control.

Evidence actually indicates there are a lot of strong friend networks in disorganized communities--and they sometimes facilitate crime rather than protect. Later colelctive efficacy work will move beyond this.

--

* "What sort of implications might [social disorganization] have for individuals in the global context that involved become engaged in organized crime? For instance cosa nostra in Italy or similarly Eastern European syndicates, or various cartels that share family and community structures within the organization themselves?"

???

Differential social organization may speak more strongly to this than original social disorganization. Some of these may represent a extreme levels of disorganization giving way to alternate control systems--or systems organized around different goals and values.

---
# Yet More

* "Juvenile Delinquency in Urban Areas mentioned that rich neighborhoods have the lowest rate of delinquents. However, could it be that they don't actually have the lowest rate but that they have the lowest rate caught by the police?"

???

Absolutely! Shaw & McKay worked with the absolute best data available to them, which was largely court data. They did also use ethnographic evidence but that can't speak to distributions. Later social disorganization work heavily uses self-report and victimization data to overcome this.

--

* "Does the discourse about the "dangers of the inner city" become a self-enforcing principle? How does this rhetoric affect things like white flight, allocation of city budgets, and the desire of potentially helpful and mitigating institutions to want/not want to settle there?"

???

Yes! We're about to start reading on this.

--

* "Sampson and Grove talk about social disorganization as the 'inability of community structures to realize common values of residents and maintain effective social controls'. How does the suburban/urban difference in association with their community (identification with their cul-de-sac versus with their block or neighborhood) apply to this concept?"

???

Is this about the different conceptions of neighborhood here or about the differences in norms? On the former, neighborhood is fuzzy and the units often used don't match up. Some more recent work has used more complex conceptions of neighborhoods. On the latter, informal social control is about regulating communities according to their own norms. This means if you want to fairly compare very different places, you need to either account for differences in norms or use universally proscribed behaviors.
