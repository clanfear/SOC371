...
date: "Jul 27, 2020<br>Updated: `r gsub(' 0', ' ', format(Sys.Date(), format='%b %d, %Y'))`"
output:
...
Subcultural and strain models; so-so to weak support but persistent to explain deficiencies in social disorg models while staying away from inherent criminality models
...
Evidence against monolithic value systems; resistance to enforcement of conformity
...
Inequality persists because it profits the growth machine in collusion with public officials and businesses
...
A parallel vein of research on social control was occurring at same time
...
Note tt is also *not* socialization in the common sense--social control is group and goal specific.
...
Hunter elaborated the connection between the system of ties in communities to social control.
...
--
   ...
   * Public: Outside agencies and organizations
     ...
     * Allocation of resources to indigenous orgs
...
Not about morality--about maintaining shared goal of basic safety
...
.footnote[From Bursik & Grasmick (1999:39)]
...
* "Does this book, its thesis, and its empirical research support or dispel the following theory?: 'Systemic racism means that even in the complete absence of individual racial bias and racially discriminatory acts, institutions such as the criminal justice system would still operate in a way that produces racially-biased affects.'"

--

* "Imagine you were a socially-liberal white homeowner and the city told you it was planning a public housing project in your neighborhood. You're all for integration, but at the next HOA meeting, you find out this project is going to decrease your home value in real dollars. What would your initial reaction be and why? How would you propose to address the issue?"

---
# Some More Questions

* "It is mentioned within Divergent Social Worlds that the "crime-ridden ghetto" can be widely seen within our culture. Where do we see this? Is there any visual media that has a non-stereotypical representation of the "crime ridden ghetto"?" and "What role do the media (i.e. television, magazines, podcasts etc.) play in perpetuating racial stigmas/etiquette in the minds of the public? What are possible forms of combating this?"

--

* "With neighborhoods being structurally caused, do you think it'll be possible to break down white neighborhoods and make them all [or most] integrated neighborhoods?" or, alternatively, to produce equal conditions in racially segregated neighborhoods?

---
# Some Clarifications

* Why is murder the leading cause of death for young African-American males? What is the direct cause?

???

Most directly it is involvement in crime and gangs; secondarily it is proximity to others' involvement in crime and gangs.

--

* What is up with female headed households as a disadvantage indicator?

???

This is a combination of path dependence on indicators and a lingering important reason. Single mothers face a wage penalty single fathers do not and single mothers are much more numerous than single fathers.

--

* "[A]re... homeless ever considered in the violence and neighborhood studies?"

???

Hard population to reach and very vulnerable. They're counted among victims because they're in vital statistics. They're rarely reached via surveys of victimization or perpetration. Lot of ethnographic work has reached them. Chris Herring for instance on police interactions with homeless. I'm doing some work in this area but I am not an expert.

--

* Why is it so difficult to study the race-class-violence nexus? And how does this generalize outside the US?

???

Issue in the US is class and race are so tightly intertwined that you can't get comparison groups. Think about lecture on methods. Need to be able to hold constant factor you're not interested in (class) and see variation in treatment (race). But when class always differs by race, can't separate effects. As far as generalization--probably not to most first world countries. More extreme segregation here than any other 1st world. Not sure about in developing places. Lot of places have strong racial and ethnic hierarchies but without as much segregation.

--

* What directly causes neighborhood segregation? Why is it so persistent?

???

Many small factors work together. Policies such as locating low income housing in black neighbs and local control of zoning, behavior of critical actors like banks and real estate, well-off residents avoiding black neighborhoods and leaving when folks move in. Active resistance in neighborhoods. Persistence is because it is fundamentally hard to address and there is little political will to do so. Segregation means the problems stay outside the seat of power.

--

* "How can you make recorded crime rates reflect crime in all neighborhoods to the same degree ? Cops are more likely to report black crime than white crime due to institutionalized racism, how can we counteract this?"

???

Honestly we probably don't. The reality is that race of offender or perceived offender influences calling police and police treat people differently based on race. Need to be aware that police data is not crime data. It is customer service records. It records how often customers ask for a service and how they respond to those customers. Hard to know the factors that drive reporting in first place.

---
# Some More Clarifications

* "What is the difference between institutionalized racism and systemic racism?"

???

Most use these as synonyms. Some make a distinction but I don't think it is real firm since definitions of institutions and systems aren't firm.

--

* To what degree is the higher crime rate in African-American neighborhoods due to increasing policing and arrests?

???

For some crimes, a lot--like drug crimes. But for violence, rates of arrest for violent crimes in black neighborhoods are actually lower than in other neighborhoods. Victimization and self-report data show similar patterns to police data.

--

* What about the Code of the Street?
...
* "What is the difference between 'race-based differentials' and 'segregated "centers" of color' (page 5 middle of second to last paragraph)?"

???

The former is what appear to be race based differences in crime; the latter is different places which suffer under concentrated disadvantage. The crime differences in race are attributable to black folk being concentrated in incredibly disadvantage places.

--

* "... many "divergent social groups" are categorically segregated such as homogeneous immigrant-populated neighborhoods that still have a strong level of community investment. Wouldn't crime rates be lower in these areas as many of these individuals would have internal-cultural connection to one another, especially given their close proximity to the group?"

???

Crime rates do tend to be lower in many types of immigrant ethnic enclaves--Asian and Latin for instance. But these advantages decline rapidly with generations.

--

* "Are integrated neighborhoods mentioned the result of gentrification?"

???

Some probably are--likely why their income numbers are so much higher. Hard to know though. Gentrification not super easy to define and measure and they didn't look.
...
* Sampson, Robert J. 2006. “Social Ecology and Collective Efficacy Theory.” Pp. 132-140 in *The Essential Criminology Reader*. Edited by S. Henry and M.M. Lanier. Boulder, CO: Westview.
