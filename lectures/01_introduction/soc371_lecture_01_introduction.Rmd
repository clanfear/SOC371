...
* Courses in LSJ and Sociology deal with (1) and (3)
...
2. Section
   ...
   + You provide (most) discussion questions
   * There may be activities

???

Lecture should virtually always end early.
...
If unable to attend, you can submit a 1-page reading and discussion responses *prior to scheduled section discussion*.

* This option must be preapproved by me/TA via email
...
2 (or more) discussion questions
   + Submit via Canvas
   + Due 5 PM the day prior to section
...
You can *in addition* write clarification questions. These will be answered in section or lecture.
...
*Emphases of exams is demonstrating understanding, critical thinking, and application of concepts, not regurgitation of facts, names, or dates.*
...
Qual often generates theories and questions

Quant tests them and looks at generalizability

Qual examines mechanisms and assumptions
