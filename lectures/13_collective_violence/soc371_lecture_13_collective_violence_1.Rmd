...
date: "Aug 17, 2020<br>Updated: `r gsub(' 0', ' ', format(Sys.Date(), format='%b %d, %Y'))`"
output:
...
COllective action implies agreement on an objective for action and agreement on the methods to accomplish that objective. For instance, collective efficacy's objective is typically control of delinquency in the neighborhood and the means are direct sanctioning and monitoring.
...
Goal of nascent social movements is to align the interpretations of individuals with those of the organization.
...
You can imagine then that collective action is much easier to facilitate when a social efficacious actor is a hub of connection in a group.
...
* "Matsueda writes that role-taking is the most effective form of social control. How does this idea interact with normative conflict? Do you believe more homogeneous societies have less crime because it's easier to role-take and identify with one another? How might America's diversity impede its collective efficacy and social organization?"

???

Discussion short today--ran out of time assembling questions; got most of the clarifications though.

--

* "Does Gamson's framework for effective social movements align with the movement to defund the police? Where might that movement improve to be successful?" and "...do you feel as though the supporters have created a sense of "other"? If so, how is this effective in the movement or does it detract [from its effectiveness]?"

???

Gamson's framework: 

1. Defines root of the problem and its solution collectively rather than individually
2. Defines the antagonists
3. Defines an injustice that can be corrected through a challenger's action

--

* Did your community have someone [who is socially efficacious]... or in your life? How has that changed your life path?

---
# Some Clarifications

* "Are white-collar crimes also a generational thing like how teenage delinquent groups learn from older delinquent groups?"

???

I am not sure if there is firm evidence for this, but I'd suspect one could find a nugget of truth there by looking at things like the subprime mortgage fiasco leading to the 2008 crash. Evidence of learning from senior to junior colleagues. If you consider military or police misconduct as white collar crime, definitely evidence there.

--

* "In the paper, it says 'Becker argued that the creation of deviance and crime begins with the process of rule creation, which is often instigated by moral crusaders, who are typically from upper classes, motivated by humanitarian concerns...' What happens when the upper class is not motivated to stop mostly white-collar crimes? Or things like exploitation of workers?"

???

It is an argument for how we end up in the very situation we are in now. We've been pretty slow to expand protections for workers and do anything about white collar crime. Things like tort reform continue to erode consumer rights and insulate companies from liability.


--

* "If the occurrence of crime relies heavily on definitions of crime being favorable, how is the Differential Association theory affected when there is a strong combination of definitions in favor and not in favor of crime?"

???

If you get lots of both, you end up in a moderate crime situation. Lot of exposure to both. Since it is the ratio of definitions that matters, differential exposure is critical. Comes down to the groups you're enmeshed in. 

--

* "In Matsueda’s article, he mentioned that 'definitions favorable to crime can be offset by definitions unfavorable to crime'. According to what he said, can we [alter definitions to reduce] their likelihood of commit[ing] crimes in the future?"

???

That is what the theory implies, but going about it requires some thought. Consider definitions have attributes like priority and intensity based on where they're coming from. If the individual does not trust or respect the source--such as the authorities--the definitions won't be persuasive. Similar to age-graded control theory, best approach is getting people to change their context to places where they're surrounded by anti-crime definitions from people they respect.

---
# More Clarifications

* "...Matsueda quotes Sutherland in saying, within the context of war, private property (and private property laws) can decrease the amount of theft in a community. If this is true, how would a socialist argue that the absence of private property is better for a society? Can Sutherland's position be held up by a social criminologist?"

???

The point here is somewhat nuanced. The idea is that government policy of requisitioning private property for the war effort undermined existing norms of sanctity of private property. If the government can seize it freely, then it is easier to make leap to being okay for others to take things as well in certain contexts. In a socialist system without private property, theft takes on a somewhat different meaning--all theft of property is theft from the government. I don't think the same issue occurs here. But one might assume a transition to such a system could produce that.

--

* "Clarification: Are all stages of moral reasoning learning processes?"

???

I am not an expert, but to my reading yes: The stages of moral reason are based on internal construction of justifications. They are not innate, but arrived at through experience and learning--but that occurs in the context of cognitive development as well.

--

* "How would Matsueda use Sutherland’s principles of criminology to explain the ways in which organizations that objectively deter criminal behavior, sometimes compel individuals to deviate because of their aversion to social control? (i.e. detention)"

???

"Sutherland is assuming that crime rates are the result of both criminal patterns or organization and the reactions to crime or organization against crime. Thus, societal reactions or what later became known as labeling, is endemic to differential organization."
