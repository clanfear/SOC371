...
Think of last part as an issue of efficacy: If a task is perceived as impossible, folks won't make the attempt. So you have to frame it as a big enough problem that one individual can handle it, but as something a group can handle together.
