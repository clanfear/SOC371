...
date: "Jan 27, 2021<br>Updated: `r gsub(' 0', ' ', format(Sys.Date(), format='%b %d, %Y'))`"
output:
...
Can use an experiment to adjudicate between them
...
We know a lot about motivation of individuals and contexts that generate likely offenders
...
This is simplified. Note that theory requires all three components to be present.

In a situation, if any one of these is missing, no crime can occur. No many how many suitable unguarded targets there are, no crime will occur if there are no offenders.

But in aggregate, independent changes in amount of one factor changes quantity of crime

---
# Levels of Explanation

Rational choice theory is micro-level
...
Routine activity theory is macro-level
...
*Rational choice and routine activity suggest crime can increase without change in motivation or number of offenders*
...
* Hard to harden many targets
* Police (guardians) can be redirected easily
...
Both because it means those most capable of protecting will benefit most and also because people won't do it

Individual target hardening helps individuals most:
...
This is an important point about all experiments and policies: Effects at small scale may look very different at large scale.
...
* Exam will go out today.

* Due 11:59 PM Saturday

   + Don't spend the entire time on it!
   + Email me if you have time concerns
...
This article is challenging and math heavy, but short

Focus on insights, don't dwell heavily on the methods but do read them, see if you can get intuition