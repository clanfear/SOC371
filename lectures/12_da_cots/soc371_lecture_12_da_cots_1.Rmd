...
date: "Aug 10, 2020<br>Updated: `r gsub(' 0', ' ', format(Sys.Date(), format='%b %d, %Y'))`"
output:
...
Sutherland's prior research in this areas.
...
Idea was controversial and subversive at time--strong assumptions about class and crime, imagine of the criminal. Publisher's of book White Collar Crime (1949) were sued by major US corporations and successfully got all references to them removed from text. Wasn't reprinted in original form for over 30 years.
...
OVerall crime rate is determined by decree of conflict--if there was no conflict, there would be consensus on law and no violations.
...
All crime comes down to learning processes. This can be directly being taught, but also observing, reinforcement of behavior, etc. Akers later expanded the learning process in Social Learning Theory using first Skinner-style behaviorism than later Bandura-style social learning.
...
Like with rational choice, the idea is holding all else constant, exposure to new favorable definitions will increase criminality. Looking at the margin!
...
This is in time of reign of subcultural theories. Rejection of idea that there is a different underlying moral code--instead they retain code but have learned to situationally neutralize it.
...
Absence of culpability; environment acted on them.
...
* "Are there times in your life—regardless of class, race, socioeconomic standing, etc—that you feel like you “code switch” in any way? If so, does this switching of self-presentation and “code” for behavior affect you internally/mentally in any way (like the example of being on guard, always having a game plan, or feeling like you're manipulating/subduing; or another outside the reading example, like stressing you out, feeling that you don’t know who you truly are, etc?"

--

* "How [could] we use differential association in a good way to reduce crime...?"

--

* "Matsueda and others suggest that all Americans become socialized to know and understand codes of violence, but wealthy white Americans are able to live life and resolve conflicts without needing to engage in them. Are there 'codes of violence' that this demographic engages in that are more subtle, and may not be physical, but are just as damaging?"

---
# Two More


* "For me personally, Anderson's "Social Ecology of Youth Violence" came off as very reductive of vibrant Black youth culture, described inner-city Black communities as a monolith, and encouraged sympathy instead of empathy. Consider his statement: "They need sympathetic people, such as potential employers, who are able to understand their predicament and are willing to give them a chance." Can you think of a suggestion that doesn't ask white people to "save" inner-city Black residents and instead empowers them to create their own success?"

???

Worth noting that I believe Anderson is describing this as a sort of immediate short-term thing. In the long-run, he is generally channeling William Julius Wilson who has focused on empowering the urban underclass primarily via economic intervention.

--

* "How could we combat the feeling of people in disadvantaged and inner-city neighborhoods have of 'they are on their own and they need to look out for themselves.' Especially now, where they feel hostile towards the police?"


---
# Some Clarifications

* "'Differential Association Theory' suggests that normative conflict refers to conflict over the appropriateness of the law. Therefore, some groups define the law as a set of rules to be followed under all circumstances, while the other groups only follow the law under some circumstances. How would this relate to collective efficacy within one of these groups?"

???

Matsueda argues that collective efficacy describes social organization against crime. It contains both norms against criminal behavior and willingess to enforce them.

--

* "... what does it signify to search for a negative in the case-by-case construction of a test (analytic induction)? It is called induction but trying to fit a hypothesis to cases seems more like deduction..."

???

The trick here is analytic induction begins with empirical observation.  Induction begins with observation then proposes a general theory. In analytic induction, one carefully looks at the association between factors. Then one derives one or more proposition from that--theories about the world. Then one introduces more cases to test. In deduction, one would 
begin with a theory, then collect evidence, then test it. Here one is starting with the evidence, observing a pattern, deriving a theory, then testing it again with different data.

--

* "Could neighborhood codes do the opposite, hypothetically (given the research is still to be done), of Shaw and McKay’s theory of collective efficacy and neighborhood codes; where the codes can be help similarly but used to deter violence and bring upon a collective efficacy of trust and norms? Even in the toughness and status perspective...?"

???

The idea of codes is value neutral. One can easily conceive of collective efficacy as a code, similarly based on norms and expectations. Rather than being based on reciprocity, the norms are of peaceful, tolerant interaction, and violations are responded to with varying levels of sanctions. With regard to toughness and physicality, it is possible for that to be the case, but I'm not aware of good examples.

--

* "[Are] there intersecting layers of social disorganization within groups like cartels and mafia? ie: Mafia/Cartel groups favor crimes against competing groups but are against it within their own organization"

???

Yes, pretty much. The contextual specificity of definitions works well for this. One may, for instance, believe the threat of violence is perfectly legitimate for coercing others outside the org but completely unacceptable inside the org.

---
# Some More

* "How can wealthier/more privileged neighborhoods have a code of the streets? Does the desire to prove oneself and show that one is “tough enough” translate to communities with higher social organization?"

???

These conceptions are ubiquitous in American society. The issue is the degree to which they are pervasive and if there are alternate status systems present and sanctions which restrain violence. The Code of the Street Anderson describes is a situation where the violence is unrestrained by other controls, there is almost no alternative status system due to concentrated disadvantage, and there is a critical mass of adherents to the code occupying public space.

--

* "How does this hypermasculinity, violence, and street code affect black women and their intersectional identities? It vaguely mentions they'll feel alienation but what other effects?"

???

There are substantial harmful effects of the code for black women, as can be imagined. Examples of code show objectification of women as status symbols and proxies for men--one might attack another man's status by taking passes at his girlfriend--or worse. It may also contribute to increased domestic and sexual violence related to authority maintenance and status production. In general, black women suffer greatly under concentrated disadvantage. As a demographic group, they have the highest rates of police contact due to victimization--I see this myself in my work with police calls. There's concern in some circles that depolicing may negatively impact black women more than any other demographic.

--

* "In Matsueda's 'Differential Association Theory', he states that Sutherland believes crime will only be committed if they have learned skills, learn to favor crime, and has objectives to commit crime. How does this work with or against the individuals that commit crime for survival?"

???

Imagine the situation if you will. If someone has the definition that it is okay to steal to prevent starvation, they have learned to steal (simple theft is an incredibly basic skill), and the opportunity to take food presents itself, you would expect they would steal food. If the food was, for example, in a locked cabinet, the skills and techniques might be more relevant.

--

* "Matsueda explains how crime came to be through the lens of differential association theory, but how would a social control theorist explain the origin of crime?"

???

Crime is the default status! People have basic instinct to be self-serving. The definition of crime is just a social establishment of limits on this inherent nature. From that perspective, the origin of crime is making it illegal--prior to that, it was not crime but it was the same behavior.
...
Home stretch! Had the book to read and a single article.
